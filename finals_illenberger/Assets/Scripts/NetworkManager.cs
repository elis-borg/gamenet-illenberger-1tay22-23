...
public class NetworkManager : MonoBehaviourPunCallbacks
{
    ...
    public void OnLoginButtonClicked()
    {
        ...
        if (!string.IsNullOrEmpty(playerName))
        {
            ...
            {
                InvalidText.GetComponent<Text>().text = "";
        ...
        {
            InvalidText.GetComponent<Text>().text = "you can't leave it empty.";
        }
    }
    ...
    public void OnCreateRoomButtonClicked()
    {
        ...
        if(GameMode != null){ //null guard
          ...
          //gm is set to fp by default, fp = freeplay, qp = quickplay, previous parameter {gm, fp}
    ...
    public void OnStartGameButtonClicked()
    {
      if(PhotonNetwork.CurrentRoom.CustomProperties.ContainsKey("gm")){
        if(PhotonNetwork.CurrentRoom.CustomProperties.ContainsValue("fp")){ //initialize freeplay gm
          Debug.Log("Loading in Freeplay.");
          PhotonNetwork.LoadLevel("FreeplayScene");
        }
        else if(PhotonNetwork.CurrentRoom.CustomProperties.ContainsValue("qp")){ //initialize quickplay gm
          Debug.Log("Loading in Quickplay.");
          PhotonNetwork.LoadLevel("QuickplayScene");
        }
      }
    }
    //#endregion
    ...
    public override void OnJoinedRoom()
    {
      ...
      if(PhotonNetwork.CurrentRoom.CustomProperties.TryGetValue("gm", out gameModeName)){
        ...
        if(PhotonNetwork.CurrentRoom.CustomProperties.ContainsValue("qp")){
          GameModeTxt.text = "Quickplay Mode. \n Let the hunt begin!";
        }
        else if(PhotonNetwork.CurrentRoom.CustomProperties.ContainsValue("fp")){
          GameModeTxt.text = "Freeplay Mode. \n Let the hunt begin!";
        }
      }
